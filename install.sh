...
apt-get -y  install zhcon cmus elinks nginx vsftpd torchat htop smplayer virtualbox etherape lolcat ninvaders moon-buggy bastet greed weechat brasero uget vail-evasion bettercap 
